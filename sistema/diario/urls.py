...
urlpatterns = [
    ...
    path("diario/terapeuta/<int:id_terapeuta>",
         views.listar_diarios_por_terapeuta, name="listar-diarios-por-terapeuta"),
    path("diario/paciente/<int:id_paciente>",
         views.listar_diarios_por_paciente, name="listar-diarios-por-paciente"),
    path("diario/<int:id_diario>", views.buscar_diario_por_id,
         name="buscar-diario-por-id"),
    ...
    path("checklist/observacao", views.adicionar_observacao_checklist,
    ...
    path("diario/<int:id_diario>/midias",
    ...
    path("diario/vincular/terapeuta", views.vincular_diario_terapeuta,
         name="vincular-diario-terapeuta"),
    path("diario/vincular/familiar", views.vincular_diario_familiar,
         name="vincular-diario-familiar"),
]
