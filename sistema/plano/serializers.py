...
class CriarPlanoIn(serializers.Serializer):
    ...
    mensagem_plano = serializers.CharField(max_length=2000, required=False, allow_blank=True, allow_null=True)
...
class AtualizarMensagemIn(serializers.Serializer):
    id_plano = serializers.IntegerField(min_value=1)
    mensagem_plano = serializers.CharField(max_length=2000, allow_blank=True, allow_null=True)
